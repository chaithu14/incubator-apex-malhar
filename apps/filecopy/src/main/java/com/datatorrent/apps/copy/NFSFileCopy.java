...
import com.datatorrent.lib.io.fs.NFSInputModule;

/**
 * Application for HDFS to HDFS file copy
 */
@ApplicationAnnotation(name = "NFSFileCopyApp")
public class NFSFileCopy implements StreamingApplication
{
  @Override
  public void populateDAG(DAG dag, Configuration conf)
  {

    NFSInputModule inputModule = dag.addModule("HDFSInputModule", new NFSInputModule());
