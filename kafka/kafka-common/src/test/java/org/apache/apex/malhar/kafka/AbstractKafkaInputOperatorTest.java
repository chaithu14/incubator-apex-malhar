...
public abstract class AbstractKafkaInputOperatorTest
{
  ...
  public abstract AbstractKafkaInputOperator createAndAddKafkaOpToDAG(DAG dag, String testName);

  public abstract DefaultOutputPort getOutputPortOfKafka();
  ...
  public void testInputOperator(boolean hasFailure, boolean idempotent) throws Exception
  {
    ...
    AbstractKafkaInputOperator node = createAndAddKafkaOpToDAG(dag, "kafka input" + testName);
    ...
    dag.addStream("Kafka message" + testName, getOutputPortOfKafka(), collector.inputPort)
      .setLocality(Locality.CONTAINER_LOCAL);
