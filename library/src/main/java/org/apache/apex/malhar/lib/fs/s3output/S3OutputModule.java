...
public class S3OutputModule implements Module
{
  ...
  public void populateDAG(DAG dag, Configuration conf)
  {
    ...
    S3InitiateFileUpload initiateUpload = dag.addOperator("InitiateUpload", new S3InitiateFileUpload());
    ...
    S3BlockUpload blockUploader = dag.addOperator("BlockUpload", new S3BlockUpload());
    ...
    S3FileMerger fileMerger = dag.addOperator("FileMerger", new S3FileMerger());
    ...
    dag.setAttribute(fileMerger,Context.OperatorContext.PARTITIONER, new StatelessPartitioner<S3FileMerger>(noOfFileMergers));
    // Add Streams
   ...
   */
  public int getNoOfFileMergers()
  {
    return noOfFileMergers;
  }

  /**
   * Set the partition count of S3FileMerger Operator
   * @param noOfFileMergers given partition count
   */
  public void setNoOfFileMergers(int noOfFileMergers)
  {
    this.noOfFileMergers = noOfFileMergers;
  }
}
