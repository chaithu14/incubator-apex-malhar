...
public class S3InitiateUploadTest
{
  ...
  public class S3InitiateFileUploadTest extends S3InitiateFileUpload
  {
    @Override
  ...
  public void testInitiateUpload()
  {
    ...
    CollectorTestSink<S3InitiateFileUpload.UploadFileMetadata> fileSink = new CollectorTestSink<>();
    ...
    S3InitiateFileUpload.UploadFileMetadata emitted = (S3InitiateFileUpload.UploadFileMetadata)tmp.collectedTuples.get(0);
